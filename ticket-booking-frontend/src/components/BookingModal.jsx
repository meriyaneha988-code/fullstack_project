  ...
  return (
    <div className="fixed overflow-scroll inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-lg p-5 rounded-xl shadow-xl">
        ...
        {/* EVENT INFO */}
        <div className="grid grid-cols-2 bg-[#8a0c15]/40 p-3 rounded-lg text-sm space-y-2">
        ...
        {/* SCREEN */}
        <div className="mt-4">
          <div className="text-center text-[#8a0c15] text-sm mb-1">SCREEN</div>
          <div className="mx-auto w-2/3 h-2 bg-[#8a0c15] rounded-full"></div>
        </div>

        {/* SEAT SELECTION */}
        <div className="mt-6 space-y-10 max-h-[250px] overflow-y-auto pr-2 text-[#8a0c15]">
            ...
            return (
              <div key={rowKey} className="grid place-items-center relative">
                ...
                >
                  ...
                  ${
                    seat.isBooked
                      ? "bg-gray-400 border-[#8a0c15] cursor-not-allowed text-[#8a0c15] scale-105 shadow"
                      : selectedSeats.includes(seat.number)
                      ? "bg-gray-300 text-black  scale-105 shadow"
                      : "bg-[#8a0c15]/50 border-[#8a0c15]/70 hover:bg-[#8a0c15]/60"
                  }
                `}
                      >
                        <Armchair
        ...
        {/* PRICE BOX */}
        <div className="bg-[#8a0c15]/40 border p-3 mt-5 rounded-lg text-sm">
          ...
          <div className="flex justify-between font-bold text-[#8a0c15] text-lg mt-1">
            <span>Total:</span>
            <span>${total}</span>
          </div>
        </div>
        ...
        <div className="flex justify-between mt-5">
          ...
          <button
            ...
            className="w-[48%] py-2 rounded-full bg-[#8a0c15]/80 text-white hover:bg-[#8a0c15]/100 font-semibold disabled:opacity-40"
          >
            Confirm
          </button>
        </div>
