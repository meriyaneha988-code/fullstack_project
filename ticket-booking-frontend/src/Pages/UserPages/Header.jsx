...
const Header = () => {
  ...
  const navClass = ({ isActive }) =>
    isActive
      ? "text-[#8a0c15] border-b-2 border-#8a0c15 pb-1"
      : "text-gray-500 hover:text-[#8a0c15]";
      ...
      <header className="w-full bg-white shadow-sm px-6 pt-4 border-b border-b-gray-200">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-white-500 w-24 h-24 rounded-4xl flex items-center justify-center">
              <span className="text-white w-20 h-20 font-bold text-2xl">
                <img src="/logoo.jpg" />
              </span>
            </div>
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">TicketHub</h1>
              <p className="font-bold text-xl text-gray-500">Hi, {name} </p>
            </div>
          </div>
