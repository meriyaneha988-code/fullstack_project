        ...
        <div className="w-full flex my-20 justify-center items-center ">
            <div className="max-w-xl mx-auto bg-white rounded-2xl shadow-sm p-5 border border-gray-200">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        <h2 className="text-lg font-semibold flex items-center gap-2">
                            <User className="text-[#8a0c15]" size={18} />
                            Personal Information
                        </h2>
                        <p className="text-sm text-gray-500 font-bold">Update your personal details</p>
                    </div>

                    {isEditing ? (
                        <button
                            onClick={handleSave}
                            className="flex items-center gap-2 bg-[#8a0c15]/80 text-white px-5 py-2 rounded-full hover:bg-[#8a0c15]/100 transition"
                        >
                            <Save size={16} /> Save
                        </button>
                    ) : (
                        <button
                            ...
                            className="font-bold text-sm flex items-center gap-2 border border-[#8a0c15] text-[#8a0c15] px-4 py-2 rounded-full hover:bg-[#8a0c15]/10 transition"
                        >
                ...
                <div className="flex flex-col items-center text-center mt-5">
                    <div className="w-16 h-16 rounded-full bg-[#8a0c15] flex items-center justify-center text-white text-xl font-bold">
                        {user?.initials}

                    </div>

                    <h3 className="text-lg font-bold mt-2">{user?.name}</h3>
                    <p className="text-gray-500 font-bold">{user?.email || "Email"}</p>

                    <div className="flex gap-2 mt-2">
                        <span className="px-3 py-1 rounded-full text-sm bg-[#8a0c15]/40 text-[#8a0c15]/100">{user?.role}</span>
                ...
                <div className="flex justify-center gap-10 mt-5">
                    <div className="text-center">
                        <p className="text-xl font-bold">{user.totalBookings}</p>
                        <p className="text-gray-500 font-bold">Bookings</p>
                    </div>
                    <div className="text-center">
                        <p className="text-xl font-bold">{user.cancelledBookings}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <div>
                        <label className="flex items-center gap-2 text-gray-600 font-medium mb-1">
                            <User size={16} className="text-[#8a0c15] font-bold" /> Full Name
                        </label>
                        <input
                            type="text"
                            name="name"
                    ...
                    <div>
                        <label className="flex items-center gap-2 text-gray-600 font-medium mb-1">
                            <Mail size={16} className="text-[#8a0c15] font-bold" /> Email Address
                        </label>
                        <input
                            type="email"
                            name="email"
                    ...
                    <div>
                        <label className="flex items-center gap-2 text-gray-600 font-medium mb-1">
                            <Calendar size={16} className="text-[#8a0c15] font-bold" /> Member Since
                        </label>
                        <input
                            type="date"
                    ...
                    <div>
                        <label className="flex items-center gap-2 text-gray-600 font-medium mb-1 font-bold">
                            <Phone size={16} className="text-[#8a0c15]" /> Mobile Number
                        </label>
                        <input
                            type="text"
                            name="mobile"
