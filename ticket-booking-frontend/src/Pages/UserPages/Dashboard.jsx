            ...
            <div className="bg-gray-50 min-h-screen">
                <div className="max-w- mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-gray-500 mt-1 text-lg font-bold ">
                            ...
                            >
                                <div className="w-full">
                                    <div className={`w-full flex justify-between items-center text-white  mb-4`}>
                                        ...
                                        <div>
                                            {stat.tag && (
                                                <span className="text-xs font-semibold text-white bg-[#c28004e7] px-3 py-1 rounded-full">
                                                    {stat.tag}
                                                </span>
                                            )}
                                        </div>
                                    ...
                                    <div>
                                        <p className="text-gray-600 text-xl font-bold">{stat.title}</p>
                    ...
                    <div className="flex items-center justify-between mb-5">
                        <div>
                            ...
                            <p className="text-gray-500 text-sm font-bold">Book your tickets now</p>
                        </div>
                        <button onClick={() => navigate('/user/events')} className="text-[#8a0c15] text-sm font-medium hover:underline">
                            View All
                        </button>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-gray-500 text-sm mb-5 font-bold">
                                            {event.description}
                                        </p>
                                        ...
                                        <div className="space-y-3 text-sm text-gray-600">
                                            ...
                                            <div className="flex items-center gap-2 font-bold">
                                                <Users size={18} /> {parseInt(event.bookingCount)}/{event.capacity} booked
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <div className="w-full h-2 rounded-full bg-gray-200 font-bold">
                                                <div
                                                    className="h-2 bg-[#8a0c15] rounded-full"
                                    ...
                                    <div className="flex items-center justify-between border-t pt-4 mt-6">
                                        ...
                                        <button className="bg-[#8a0c15]/90 text-white cursor-pointer px-6 py-2 rounded-full text-sm hover:bg-[#8a0c15]/100 transition" onClick={() => {
