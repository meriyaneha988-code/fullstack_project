...
const statusStyles = {
    UPCOMING: "bg-[#8a0c15]/20 text-[#8a0c15]/100",
    COMPLETED: "bg-[#8a0c15]/50 text-[#8a0c15]/100",
    LIVE: "bg-[#8a0c15]/50 text-[#8a0c15]/100",
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-3xl p-6 w-[90%] max-w-md shadow-lg relative">
                ...
                <div className="flex justify-center mb-4">
                    <div className="cursor-pointer w-16 h-16 flex items-center justify-center rounded-full bg-[#8a0c15]/50">
                        <X size={36} className="text-[#8a0c15]/100" />
                    </div>
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    <button
                        ...
                        className="cursor-pointer flex-1 bg-[#8a0c15]/50 text-white rounded-full py-2 text-sm hover:bg-[#8a0c15]/100"
                    >
                        Sure
                    </button>
                </div>
                ...
                {bookings.map((booking) => (
                    ...
                    >
                        ...
                        <div className="text-sm mb-4 space-y-4">
                            <div className="gap-2 bg-[#8a0c15]/20 rounded-lg p-4">
                                <div className="flex items-center text-xs text-gray-800 space-x-2">
                                    <Calendar size={14} className="text-[#8a0c15]/100" />
                                    <p>Date</p>
                                </div>
                                <p>{booking.date}</p>
                            </div>

                            <div className="gap-2 bg-blue-100 rounded-lg p-4">
                                <div className="flex items-center text-xs text-gray-800 space-x-2">
                            ...
                            <div className=" gap-2 bg-purple-100 rounded-lg p-4">
                                <div className="flex items-center text-xs text-gray-800 space-x-2">
                            ...
                            <div className="gap-2 bg-[#c28004e7]/20 rounded-lg p-4">
