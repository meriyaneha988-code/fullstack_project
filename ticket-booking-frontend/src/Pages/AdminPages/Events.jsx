    ...
    <div className="p-8">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#8a0c15]/100 text-white px-5 py-2 rounded-full"
        >
          ...
          return (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 mt-3">
                <div className="flex items-center gap-2 bg-[#8a0c15]/40 p-2 rounded-full">
                  <Calendar size={16} />
              ...
              <div className="flex justify-between mt-4 items-center">
                ...
                <button
                  ...
                  className={`w-12 h-6 rounded-full ${event.active ? "bg-[#8a0c15]/70" : "bg-gray-300"
                    }`}
                >
                  <div
          ...
          <div className="bg-white p-6 rounded-3xl w-full max-w-lg relative">
            ...
            <div className="space-y-3">
              <div>
                ...
                />
                {errors.title && (
                  <p className="text-[#8a0c15]/100 text-sm mt-1">{errors.title}</p>
                )}
              </div>
              <div>
                ...
                {errors.description && (
                  <p className="text-[#8a0c15]/100 text-sm mt-1">{errors.description}</p>
                )}
              </div>
