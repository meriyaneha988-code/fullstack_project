        ...
        <div className="w-full p-6 bg-gray-50 min-h-screen">
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3 w-full">
                    ...
                    {/* Search Icon */}
                    <button
                        className="cursor-pointer relative left-1 bg-red-500 hover:bg-red-600 text-white rounded-full p-2 shadow-md transition"
                    >
                        <Search size={16} />
                    </button>
                    ...
                    <input
                        ...
                        className="px-5 py-2 pr-12 rounded-full border border-gray-200 bg-white shadow-sm w-72 focus:outline-none focus:ring-2 focus:ring-Red-200"
                        value={searchTerm}
            ...
            <div className="bg-white rounded-t-xl overflow-hidden">
                <table className="w-full text-sm">
                    <thead className="bg-red-50 text-gray-800 font-semibold">
                        <tr>
