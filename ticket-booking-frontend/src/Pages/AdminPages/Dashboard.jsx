        ...
        <div className="w-full p-6 space-y-6">
            ...
            {bookings.length > 0 && <div>
                <div className="flex justify-between items-center mb-3">
                    ...
                    <button className="text-[#8a0c15]-500 text-sm cursor-pointer font-medium"
                    ...
                    {bookings.map((booking) => (
                        <div key={booking.id} className="bg-white rounded-2xl shadow-sm p-4 flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-3">
                                <span className="text-xs bg-[#8a0c15]/10 text-[#8a0c15]-90 px-2 py-1 rounded-full">
